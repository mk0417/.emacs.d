...
;;;; capture
;; NOTE 2023-06-17 11:02:53 +0100: minor tweaks
(setq org-capture-templates
      `(("b" "Basic task for future review" entry
         (file+headline "review.org" "Tasks to be reviewed")
         ,(concat "* %^{Title}\n"
                  ":PROPERTIES:\n"
                  ":CAPTURED: %U\n"
                  ":END:\n\n"
        ...
        ("t" "Task with a due date" entry
         (file+headline "todo.org" "Tasks with a date")
         ,(concat "* TODO %^{Title} %^g\n"
                  "SCHEDULED: %^t\n"
                  ":PROPERTIES:\n"
                  ":CAPTURED: %U\n"
...
(with-eval-after-load 'org
  (evil-define-key 'normal org-mode-map "o" #'p-org-open-below-no-indent))
